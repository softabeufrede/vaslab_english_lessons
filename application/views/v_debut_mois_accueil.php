...
<h1>Pour cette offre,vous serez facturé de 206 FCFA. Vous aurez droit à 30 jours de cours d’anglais.</h1>
      <a href="<?php echo base_url() ?>offre/debutant/mois/confirme">Confirmer</a><br/>
      <a href="<?php echo base_url() ?>">Annuler</a><br/>
      <a href="<?php echo base_url() ?>offre/mois">Retour</a><br/>
